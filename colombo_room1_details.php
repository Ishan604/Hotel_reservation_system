...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btnreserve'])) 
{
    ...
    $query = "SELECT is_available FROM rooms WHERE room_no = '$roomNo' AND hotel_id = 3";
...
if ($conn) 
{
  $query = "SELECT room_no, is_available FROM rooms WHERE hotel_id = 3";
    $result = mysqli_query($conn, $query);
...
<body>
  ...
  <section class="apartment-overview container">
    ...
    <div class="photo-gallery">
      <h2>007 Colombo</h2>
      <h6 style="color: blue;">No. 27, Marine Drive, Colombo 07, Sri Lanka</h6>
      <div class="photo-grid">
        <img src="img/colombo_room1/room1.jpg" alt="Room Image" />
        <img src="img/colombo_room1/room2.jpg" alt="Room Image" />
        <img src="img/colombo_room1/room3.jpg" alt="Room Image" />
        <img src="img/colombo_room1/room4.jpg" alt="Room Image" />
        <img src="img/colombo_room1/room5.jpg" alt="Room Image" />
        <img src="img/colombo_room1/room6.jpg" alt="Room Image" />
        <img src="img/colombo_room1/room7.jpg" alt="Room Image" />
        <img src="img/colombo_room1/room9.jpg" alt="Room Image" />
      </div>
    </div>
    ...
    <div class="about-property">
      ...
      <p>007 Colombo is situated in the vibrant heart of Colombo, offering convenient access to major city attractions and coastal views. This apartment is thoughtfully designed with comfort and style in mind, featuring contemporary amenities to make your stay enjoyable.</p> 
      <p>Relax in a spacious living area, cook with ease in the fully equipped kitchen, and unwind in cozy, well-furnished bedrooms. Whether you're staying for a few days or a longer visit, 007 Colombo provides a peaceful and modern retreat for a truly comfortable experience.</p>
    </div>
        ...
        <tr>
          ...
          <td>
            <ul>
              ...
              <li><img src="img/icons/mark.png" alt="Check" /> One family room with two single beds</li>
    ...
    <table class="room-info-table">
        ...
        <tr>
          ...
          <td>
            <ul>
              <li><img src="img/icons/mark.png" alt="Check" /> Continental breakfast included</li>
              <li><img src="img/icons/mark.png" alt="Check" /> Double room with three large bed</li>
              <li><img src="img/icons/mark.png" alt="Check" /> Free cancellation before <?php echo $checkIn; ?></li>
              <li><img src="img/icons/mark.png" alt="Check" /> No prepayment needed – pay at the property</li>
              <li><img src="img/icons/mark.png" alt="Check" /> Credit card details needed
                  <span style="color: red; padding-left: 10px; font-size:smaller">*or else the reservation will cancel at 7.00 P.M</span>
    ...
    <table class="room-info-table">
        ...
        <tr>
          ...
          <td>
            <ul>
              <li><img src="img/icons/mark.png" alt="Check" /> Continental breakfast included</li>
              <li><img src="img/icons/mark.png" alt="Check" /> Single room with one Large Bed</li>
              <li><img src="img/icons/mark.png" alt="Check" /> Free cancellation before <?php echo $checkIn; ?></li>
              <li><img src="img/icons/mark.png" alt="Check" /> No prepayment needed – pay at the property</li>
              <li><img src="img/icons/mark.png" alt="Check" /> Credit card details needed
                  <span style="color: red; padding-left: 10px; font-size:smaller">*or else the reservation will cancel at 7.00 P.M</span>
