...
<body>
  ...
  <section class="room-results container">
    ...
    <!-- Room 1 -->
    <div class="room-card" style="font-family: Arial;">
      ...
      <div class="room-info">
        ...
        <a href="colombo_room1_details.php" class="btn search-btn">See availability</a> 
      </div>
    </div>
    ...
    <div class="room-card" style="font-family: Arial;">
      ...
      <div class="room-info">
        <a href="room_page.php" style="text-decoration: none;">
          <h3>Ashly Home - Your home away home</h3>
        </a>
        <p class="review-rating">Awesome ★★★★★</p>
        <p>Entire suite • 3 bedrooms • 1 living room • 2 bathrooms • 1 kitchen • 1 swiminng pool</p>
        <p>Size: 225 m<sup>2</sup></p>
        ...
        <a href="colombo_room2_details.php" class="btn search-btn">See availability</a> 
      </div>
    </div>
  </section>
