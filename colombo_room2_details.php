...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btnreserve'])) 
{
    ...
    $query = "SELECT is_available FROM rooms WHERE room_no = '$roomNo' AND hotel_id = 4";
...
if ($conn) 
{
    $query = "SELECT room_no, is_available FROM rooms WHERE hotel_id = 4";
    $result = mysqli_query($conn, $query);
...
<body>
  ...
  <section class="apartment-overview container">
    ...
    <div class="photo-gallery">
      <h2>Ashly Home - Your home away home</h2>
      <h6 style="color: blue;">No. 07, Alexandra Place, Colombo 07, Sri Lanka.</h6>
      <div class="photo-grid">
        <img src="img/colombo_room2/room1.jpg" alt="Room Image" />
        <img src="img/colombo_room2/room2.jpg" alt="Room Image" />
        <img src="img/colombo_room2/room3.jpg" alt="Room Image" />
        <img src="img/colombo_room2/room4.jpg" alt="Room Image" />
        <img src="img/colombo_room2/room5.jpg" alt="Room Image" />
        <img src="img/colombo_room2/room6.jpg" alt="Room Image" />
        <img src="img/colombo_room2/room7.jpg" alt="Room Image" />
        <img src="img/colombo_room2/room8.jpg" alt="Room Image" />
    ...
    <div class="about-property">
      ...
      <p>Ashly Home – Your Home Away from Home is nestled in the heart of Colombo, offering easy access to the city’s key attractions and coastal charm. This inviting apartment is thoughtfully crafted to ensure every guest enjoys a comfortable and relaxing stay.</p>  
      <p>Featuring a spacious living area, a fully equipped kitchen, and warm, cozy bedrooms, Ashly Home is ideal for both short vacations and long-term stays. With a peaceful ambiance and all the modern conveniences, it truly feels like your home away from home.</p>
    </div>
